...
const Footer = () => {
  return (
    <footer className="bg-[#F6F6F6] text-gray-800 pt-20 pb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="mt-1 text-[#E9967A]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5"
                    fill="none"
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-600">hello@desirediv.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 space-x-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="/about"
                  className="text-gray-600 hover:text-[#E9967A] transition-colors duration-300"
                >
                  About Us
                </Link>
              </li>
